...
$overview = @(
  ...
  @("DSS strength", "Implemented beyond simple IF-THEN", "Current DSS has eligibility gates, weighted scoring, burn-test confidence, preference boost, buyback add-on, audit trail.", "Reflect this in Chapter 3 and appendices.", "docs/dss-matrix.md; ClothCycle_DSS_QA_Test_Cases.xlsx"),
...
$chapter = @(
  ...
  @("CH3-010", "Buyback", "Upcycling with buyback when item meets encoded criteria.", "Current code adds buyback when buyback_interest=true with fixed score 78; does not deeply re-evaluate partner pricing/production feasibility.", "Describe buyback as add-on interest/request route, not guaranteed eligibility/pricing.", "High", "To Do", "backend/src/services/dssEngine.ts", "Upcycling/buyback/circular business model citation.", "", ""),
...
$gaps = @(
  ...
  @("GAP-004", "DSS Recycle/Donate/Upcycle/Buyback/Rejected", "Yes", "Weighted scoring and eligibility gates.", "Thesis still describes simpler flow.", "Update thesis and appendices.", "Critical", "Implemented", "backend/src/services/dssEngine.ts; docs/dss-matrix.md", ""),
...
$dss = @(
  ...
  @("DSS-CIT-002", "Circular economy pathways include donation/reuse, recycling, and upcycling.", "Pathways are recycle, donate, upcycle, buyback add-on, rejected gate.", "Scope and DSS process flow.", "Circular economy textile lifecycle and end-of-life pathways.", "docs/dss-matrix.md", "Needs exact bibliography number", ""),
  ...
  @("DSS-CIT-008", "Buyback/upcycling supports circular value recovery but acceptance is external.", "Buyback is an add-on recommendation at fixed score 78 when user selects buyback interest.", "Buyback scope/delimitation.", "Upcycling, circular business models, buyback/take-back programs.", "backend/src/services/dssEngine.ts", "Needs source", "Do not claim guaranteed pricing."),
