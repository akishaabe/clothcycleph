...
| Item | `details.item_types`, `item_type` | What type of item/s are you submitting? | Top; Pants / Jeans; Dress; Jacket / Outerwear; Household textile; Fabric scraps; Other |
...
| Recovery | `details.wearability` | Is the item still wearable or usable? | Wearable as-is; Wearable after minor repair; Not wearable but fabric usable; Not usable |
...
| Recovery | `details.repairability` | Is the item repairable? | No repair needed; Minor repair; Moderate repair; Not practical to repair |
...
1. Safety screening: restricted textile categories.
2. Burn test optional flow: result appears before item details.
3. Item details: submission name, item type, condition, cleanliness, quantity.
...
5. Recovery criteria: wearability, damage classification, repairability, conditional contamination level, repurposing potential, trim/accessory removal.
...
| Wearability | 5 | Not necessarily wearable, but usable fabric remains |
| Repairability | 15 | Repair/redesign can preserve material value |
...
| Wearability | 0 | No longer suitable for direct reuse |
| Repairability | 5 | Moderate repair or not practical |
