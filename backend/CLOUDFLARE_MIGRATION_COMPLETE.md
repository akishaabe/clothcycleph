...
- Auth, profile, 2FA, password reset, Google login, submissions, DSS, GIS partner ranking, messages, notifications, transactions, and uploads are handled directly in the Worker.
